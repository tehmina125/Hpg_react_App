...
const ServiceDetail = () => {
  ...
  useEffect(() => {
    ...
    if (foundService) {
      ...
      setService(null);
      axios.get(`https://www.hpgautorepair.com/api/home/service/${slug}`)
        .then(response => {
    ...
    return (
      <div className="flex justify-center items-center min-h-screen">
        <div role="status">
          <svg
            aria-hidden="true"
            className="w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-red-800"
            viewBox="0 0 100 101"
            fill="none"
  ...
  const imageUrl = service.image || service.image_url || "https://via.placeholder.com/300";
